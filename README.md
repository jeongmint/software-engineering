...
## 2. 폰트 강조/꾸미기(Emphasis/Decoration)
...
---
### 중첩 리스트
- Markdown의 중첩 리스트는 다음과 같이 글머리 기호 뒤에 공백(space)를 순차적으로 붙여서 표현
...
중첩 리스트는 최대 3개까지 글머리 기호를 달리하여 표현할 수 있으며 이후 단계의 글머리 기호는 동일하게 나타남

---
<br/>

- 보통 중첩리스트는 다음과 같이 가독성의 편리함을 위해 공백(space)만을 삽입하여 표현함
...
위 처럼 표시할 때는 공백을 2n개씩 증가시켜 작성<br/>

---

### 순서가 있는 리스트
- 순서(오름차순)으로 정렬된 숫자 뒤에 '.' 붙여 사용
( 0 이상의 정수여야 함 )
